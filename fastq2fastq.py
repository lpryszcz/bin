...
def fastq2fastq( fPathF,minLen,qualityTh,ASCII_offset_33=True,verbose=False,gzlipEndings=('.gz',) ):
  ...
  try:
    while 1:
      i+=1
      rec1 = getFastQ( fileF,minLen,qualityTh,ASCII_offset_33 )
      #rec2 = getFastQ( fileR,minLen,qualityTh,ASCII_offset_33,'/2' )
      if rec1:# and rec2:
        j+=1
        sys.stdout.write( '%s' % rec1 )
...
def main():
  ...
  parser.add_option("-l", dest="minLen", default=0, type=int,
  ...
  for fPath in fPaths:
    fastq2fastq( fPath,o.minLen,o.qualityTh,o.ASCII_offset_33,o.verbose )
